...
model_dict = {
    ...
    model_type.lorentz: models.LorentzNetwork,
    model_type.logr: LinearModel
}
...
head_dict = {
   ...
   model_type.lorentz: torch.nn.Linear,
   model_type.logr: torch.nn.Identity
...
configs = [
    {'mtype': x,
     ...
     product(
        ...
        (model_type.euclidean, activation.relu),
...
base_path = Path('data/classification')
