...
class NumericalConstants:
    ...
    TANH_CLAMP_MIN: Final[float] = -15.0
    TANH_CLAMP_MAX: Final[float] = 15.0
    ATANH_CLAMP_MIN: Final[float] = -1 + EPS
    ATANH_CLAMP_MAX: Final[float] = 1 - EPS

    # Projection to Poincaré ball
    PROJECTION_EPS: Final[float] = EPS
    MAX_NORM: Final[float] = 1 - PROJECTION_EPS
